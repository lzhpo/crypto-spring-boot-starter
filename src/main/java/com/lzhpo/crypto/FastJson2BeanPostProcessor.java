...
import com.lzhpo.crypto.serializer.FastJson2CryptoValueFilter;
...
public class FastJson2BeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof FastJsonHttpMessageConverter fastJsonConverter) {
            ...
            Filter[] injectWriterFilters = {new FastJson2CryptoValueFilter()};
            ...
            log.info(
                    ...
                    FastJson2CryptoValueFilter.class.getName(),
