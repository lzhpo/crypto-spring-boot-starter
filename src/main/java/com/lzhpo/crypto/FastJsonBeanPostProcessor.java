...
import com.lzhpo.crypto.serializer.FastJsonCryptoValueFilter;
...
public class FastJsonBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof FastJsonHttpMessageConverter fastJsonConverter) {
            ...
            SerializeFilter[] injectFilters = {new FastJsonCryptoValueFilter()};
            ...
            log.info(
                    ...
                    FastJsonCryptoValueFilter.class.getName(),
